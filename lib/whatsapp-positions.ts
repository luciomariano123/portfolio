...
export const DEFAULT_POSITIONS = [
  ...
  { ticker: 'SPY',   tickerYF: 'SPYD.BA',   name: 'S&P 500 ETF',    quantity: 2019, ppc: 11.3499802, account: 'Lucio' },
  { ticker: 'MELI',  tickerYF: 'MELID.BA',  name: 'MercadoLibre',   quantity: 553,  ppc: 17.6998192, account: 'Lucio' },
  { ticker: 'META',  tickerYF: 'METAD.BA',  name: 'Meta Platforms', quantity: 881,  ppc: 26.9486040, account: 'Lucio' },
  ...
  { ticker: 'TSLA',  tickerYF: 'TSLAD.BA',  name: 'Tesla',          quantity: 600,  ppc: 24.5575670, account: 'Lucio' },
  // ── Balanz Agropecuaria ───────────────────────────────────────────────────
  ...
  { ticker: 'PAMP',  tickerYF: 'PAMPD.BA',  name: 'Pampa Energía',  quantity: 3070, ppc: 3.5157362,  account: 'Agro' },
